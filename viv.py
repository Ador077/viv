...
def emailbal():
    ...
    jalan(logo)
    limit = int(input(f'\033[0;97m[{xr}^{x}]\033[0;92m EXAMPLE :\x1b[1;91m10000, \x1b[1;91m20000,\x1b[1;91m50000 ] \n\033[0;95mтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХР \n\033[0;97m[{xr}^{x}] \033[0;92mPUT CLONING LIMIT:\033[0;93m '))
...
def pak():
    ...
    os.system('xdg-open https://www.facebook.com/ACTION-FIRE')
    os.system("clear")
    print(logo)
    ...
    with ThreadPool(max_workers=150) as manshera:
        ...
        tl = str(len(user))
        print(xd*55)
        print('\033[1;91m[\x1b[1;91m✔\033[1;91m]\033[1;92m USER\'S NAME : \033[1;92m'+bal)
        print('\033[1;91m[\x1b[1;91m✔\033[1;91m]\033[1;92m TOTAL IDS : \x1b[1;91m'+tl)
        print('\033[1;91m[\033[1;91m✔\033[1;91m]\033[1;92m CRACKING HAS STARTED')
        print('\033[1;91m[\033[1;91m✔\033[1;91m]\033[1;92m WORKS ON DATA AND WIFI')
        print(xd*55)
        for love in user:
...
def FIRE():
    ...
    os.system('clear')
    print(logo)
    limit = int(input(f'\033[0;97m[{xr}\x1b[1;91m✔{x}]\033[0;92m EXAMPLE : \x1b[1;91m10000, \x1b[1;91m20000, \x1b[1;91m50000 \n\033[1;92m══════════════════════════════════════════════════════ \n\033[0;97m[{xr}\x1b[1;91m✔{x}] \033[0;92mENTER CLONING LIMIT:\033[0;93m '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    os.system("clear")
